...
/***************** Configuration *****************/
  ...
  $contact_email_to = "jasethomson31@gmail.com";
...
/********** Do not edit from the below line ***********/
  ...
  if(isset($_POST)) {
    ...
    // $message_content = $name_title . $name . $email_title . $email . $message_title . $message;



    // var_dump("$message_content: ", $message_content);
    $sendemail = mail($contact_email_to, $subject, $message, $headers);

    // var_dump("email: ", $contact_email_to);
    // var_dump("title: ", $subject_title);
    // var_dump("subject: ", $subject);
    // var_dump("$message_content: ", $message_content);
    // var_dump("$headers: ", $headers);

    // var_dump("$sendemail: ", $sendemail);
